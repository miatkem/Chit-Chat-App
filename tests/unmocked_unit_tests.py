...
from bot import bot
from msg_parser import parse_pictures_and_links
...
class UnmockedUnitTestCase(unittest.TestCase):
    """tests that can be done without mocks"""
    def test_pars_pictures_and_links(self):
        """test the picture and link parser"""
        test_params = [
            {
                KEY_INPUT: "https://www.freepngimg.com/thumb/burger/22388-5-burger-food.png",
                KEY_EXPECTED: ("<img src='https://www.freepngimg.com/thumb/burger/22388-5-burg"
                +"er-food.png' class='msgImg'/> ")
            },
            {
                KEY_INPUT: ("No link words and then an image -> https://www.freepngimg.com/thumb"
                +"/burger/22388-5-burger-food.png"),
                KEY_EXPECTED: ("No link words and then an image -> <img src='https://www.freepng"
                +"img.com/thumb/burger/22388-5-burger-food.png' class='msgImg'/> ")
            },
            {
                KEY_INPUT: ("https://www.seriouseats.com/recipes/images/2015/07/20150702-sous-vid"
                +"e-hamburger-anova-primary.jpg"),
                KEY_EXPECTED: ("<img src='https://www.seriouseats.com/recipes/images/2015/07/"
                +"20150702-sous-vide-hamburger-anova-primary.jpg' class='msgImg'/> ")
            },
            {
                KEY_INPUT: "https://media4.giphy.com/media/7NXp5l8D4oRsm0XxiK/giphy.gif",
                KEY_EXPECTED: ("<img src='https://media4.giphy.com/media/7NXp5l8D4oRsm0XxiK/"
                +"giphy.gif' class='msgImg'/> ")
            },
            {
                KEY_INPUT: ("No link words and then a gif -> https://media4.giphy.com/media/"
                +"7NXp5l8D4oRsm0XxiK/giphy.gif"),
                KEY_EXPECTED: ("No link words and then a gif -> <img src='https://media4.giphy."
                +"com/media/7NXp5l8D4oRsm0XxiK/giphy.gif' class='msgImg'/> ")
            },
            {
            ...
            },
            {
                ...
                KEY_EXPECTED:
                    "<a href='http://www.njit.edu/' target='_blank'>http://www.njit.edu/</a> "
            },
            {
                KEY_INPUT: "No link words and then a link -> http://www.njit.edu/",
                KEY_EXPECTED: ("No link words and then a link -> <a href='http://www.njit.edu/'"
                +" target='_blank'>http://www.njit.edu/</a> ")
            },
            {
        ...
        for test_case in test_params:
            response = parse_pictures_and_links(test_case[KEY_INPUT])
